  ...
  return (
    <div className="bg-dark shadow-lg relative">
      ...
      >
        ...
        <div className="text-gray-600 dark:text-gray-400 mt-1">{props.description}</div>
        <a href={props.example || "404"} target="_blank" className=" text-gray-500 underline mt-4">Example</a>
      </a>
    </div>
  );
}
